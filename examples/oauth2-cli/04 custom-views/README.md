...
This [script](./src/index.ts) is identical to the [ejs-optional](../02%20ejs-optional#readme) example (authorize GitHub API access and request this repo), but a custom [launch.ejs](./views/launch.ejs) EJS template has been included and configured, which provides instructions and explanation to the user before launching the Authorization Code flow.
